...
add_action( 'wp_enqueue_scripts', function() {
	...
	// JAVASCRIPTS
	wp_enqueue_script( 'jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.js', array(), '3.3.1', false );
	wp_enqueue_script( 'modernizr', 'https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js', array(), '2.8.3', false );

	wp_enqueue_script( 'bootstrap',  get_template_directory_uri() . '/assets/js/vendor/bootstrap.min.js', array('jquery'), '1', true );
	wp_enqueue_script( 'sticky',  get_template_directory_uri() . '/assets/js/vendor/jquery.sticky.js', array('jquery'), '1', true );
	wp_enqueue_script( 'touchwipe',  get_template_directory_uri() . '/assets/js/vendor/jquery.touchwipe.js', array('jquery'), '1', true );
	wp_enqueue_script( 'caroufredsel',  get_template_directory_uri() . '/assets/js/vendor/caroufredsel-6.2.1.js', array('jquery'), '1', true );

	wp_enqueue_script( 'custom-functions', get_template_directory_uri() . '/assets/js/custom-functions.js', array( 'jquery' ), '1', true );
